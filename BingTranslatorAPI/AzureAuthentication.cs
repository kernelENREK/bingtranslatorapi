...
namespace AzureTranslator
{
    public class AzureAuthentication
    {
        ...
        public AzureAccessToken GetAccessToken()
        {
            return this.token;
        }
        ...
        private AzureAccessToken HttpPost(string DatamarketAccessUri, string requestDetails)
        {
            ...
            using (WebResponse webResponse = webRequest.GetResponse())
            {
                ...
                AzureAccessToken token = (AzureAccessToken)serializer.ReadObject(webResponse.GetResponseStream());
                return token;
            }
        }
    }
